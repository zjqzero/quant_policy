...
from _query import chan_k, original_k, fractal, bi, duan, level1, level2, level3, centre, original_k_by_index

t1 = time.time()
# 月线级别，最后一个底分型；最后4个分型形成 低-1>低-3 高-2>高-4 结构，且当前K线距离最后分型的特征K线<=1
stocks_1 = bi(-1, '4_1', 'direction') == -1
stocks0 = fractal(-1, '4_1', 'fractal_flag', stocks_1) == -1
...
stocks1_1 = original_k_by_index(stocks1, '4_1', 'low')
stocks2_1 = original_k_by_index(stocks2, '4_1', 'high')
stocks3_1 = original_k_by_index(stocks3, '4_1', 'low')
stocks4_1 = original_k_by_index(stocks4, '4_1', 'high')
